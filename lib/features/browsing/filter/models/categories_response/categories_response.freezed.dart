...
class _$CategoriesResponseTearOff {
  ...
  _CategoriesResponse call(List<Category> categories) {
...
/// @nodoc
@JsonSerializable()
class _$_CategoriesResponse
    with DiagnosticableTreeMixin
    implements _CategoriesResponse {
  const _$_CategoriesResponse(this.categories);
...
abstract class _CategoriesResponse implements CategoriesResponse {
  const factory _CategoriesResponse(List<Category> categories) =
