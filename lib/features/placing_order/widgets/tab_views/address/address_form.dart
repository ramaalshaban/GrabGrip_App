      ...
      children: [
        ...
        TextFormField(
          initialValue: isShippingAddressForm
              ? ref.watch(placeOrderProvider.notifier).shippingAddress?.fullName
              : ref.watch(placeOrderProvider.notifier).billingAddress?.fullName,
          onChanged: (text) {
        ...
        TextFormField(
          initialValue: isShippingAddressForm
              ? ref.watch(placeOrderProvider.notifier).shippingAddress?.postCode
              : ref.watch(placeOrderProvider.notifier).billingAddress?.postCode,
          onChanged: (text) {
            isShippingAddressForm
                ? ref
                    .watch(placeOrderProvider.notifier)
