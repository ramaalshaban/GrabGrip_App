...
class _$_SaveListingRequest
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'SaveListingRequest(publish: $publish, title: $title, description: $description, tags: $tags, listingEndDate: $listingEndDate, lat: $lat, lng: $lng, city: $city, region: $region, country: $country, price: $price, stock: $stock, minRentPeriod: $minRentPeriod, maxRentPeriod: $maxRentPeriod, additionalOptions: $additionalOptions, shippingFees: $shippingFees, variations: $variations)';
  }
